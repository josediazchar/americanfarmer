...
const translations = {
  es: {
    ...
    'products.ctaDescription': 'Contáctenos hoy mismo para recibir una cotización personalizada y descubrir cómo nuestras frutas colombianas premium pueden enriquecer su negocio.',
