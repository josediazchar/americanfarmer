        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              Su socio de confianza en la comercialización y exportación de frutas frescas de alta calidad desde Colombia hacia el mundo.
            </p>
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm text-gray-300">Calidad Certificada</span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-300">CR 107 #97-32 AP 202 PISO 2 Apartado, Colombia</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm mb-4 md:mb-0">
              © 2025 American Farmers. Todos los derechos reservados.
            </div>
